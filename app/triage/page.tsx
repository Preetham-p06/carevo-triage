...
export default function TriagePage() {
  return (
    <main className="min-h-screen overflow-hidden bg-[radial-gradient(circle_at_18%_8%,rgba(59,130,246,0.12),transparent_32%),linear-gradient(180deg,#f8fbff_0%,#ffffff_58%,#f8fafc_100%)] px-4 pb-12 pt-24 text-slate-950 sm:px-5 sm:pb-20 sm:pt-32">
      <section className="mx-auto max-w-3xl">
        <p className="mb-4 text-xs font-black uppercase tracking-[0.24em] text-carevo-600 sm:mb-5">Live Triage</p>
        <h1 className="max-w-3xl text-[clamp(2.55rem,11vw,6.6rem)] font-black leading-[1.02] tracking-[-0.06em] sm:leading-[0.9] sm:tracking-[-0.075em]">
          Start with one clear next step.
        </h1>
        <p className="mt-5 max-w-2xl text-[15px] font-semibold leading-7 text-slate-600 sm:mt-8 sm:text-xl sm:leading-9">
