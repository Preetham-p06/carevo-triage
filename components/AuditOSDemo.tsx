      ...
      <section className="mx-auto max-w-[1440px] px-4 py-4 sm:px-6">
        <header className="rounded-xl border border-cyan-100 bg-white/92 shadow-sm shadow-cyan-900/5 backdrop-blur">
          <div className="flex flex-wrap items-center justify-between gap-3 border-b border-cyan-100 px-4 py-3 sm:gap-4 sm:px-5">
            ...
            <div className="grid w-full grid-cols-1 gap-2 sm:w-auto sm:grid-cols-none sm:flex sm:flex-wrap sm:items-center">
              ...
              <Link href="/contact" className="inline-flex min-h-11 items-center justify-center rounded-md bg-cyan-900 px-4 py-2 text-sm font-black text-white shadow-sm shadow-cyan-900/15 transition hover:bg-cyan-800 sm:min-h-10">
                Request pilot
              </Link>
            </div>
          </div>
          <div className="flex flex-wrap items-center gap-x-3 gap-y-2 px-4 py-3 text-[10px] font-black uppercase tracking-[0.14em] text-slate-500 sm:gap-x-6 sm:px-5 sm:text-xs">
            ...
            <span className="text-slate-400 sm:ml-auto">Updated 2 min ago</span>
          </div>
        </header>
        ...
        <div className="mt-4 grid gap-4 xl:grid-cols-[320px_1fr]">
          <aside className="rounded-xl border border-cyan-100 bg-white/92 p-4 shadow-sm shadow-cyan-900/5 backdrop-blur xl:sticky xl:top-4 xl:self-start">
            ...
            <h1 className="mt-3 font-display text-[1.8rem] font-black leading-[1.08] tracking-[-0.055em] text-cyan-950 sm:text-3xl sm:leading-tight">
                      ...
                      <button
                        ...
                        className={`rounded-2xl border p-4 text-left shadow-sm transition ${
                          selectedId === row.id
                            ...
                            : 'border-slate-200 bg-white hover:bg-cyan-50/40'
                        }`}
                      >
                        ...
                        <p className="mt-3 text-sm font-black leading-5 text-slate-950">{row.intake}</p>
                        <p className="mt-2 text-xs font-semibold leading-5 text-slate-500">{row.member} - {row.market}</p>
                        <div className="mt-3 flex flex-wrap gap-2">
                          <Badge className={LEVEL_STYLE[row.level]}>{row.level}</Badge>
                          <Badge className="border-slate-200 bg-slate-50 text-slate-600">{row.owner}</Badge>
                        </div>
                      </button>
                    ))}
                  </div>
              ...
              {tab === 'trace' && (
                <div className="grid gap-4 p-4 lg:grid-cols-[360px_1fr]">
                  ...
                  <div className="rounded-xl border border-cyan-100 bg-cyan-50/40 p-4">
                    <p className="text-[10px] font-black uppercase tracking-[0.16em] text-cyan-700">Selected route trace</p>
                    <ol className="mt-4 space-y-3">
                      {selected.trace.map((step, index) => (
                        <li key={step} className="grid grid-cols-[34px_1fr] gap-3">
                          <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-white font-mono text-xs font-black text-cyan-700 shadow-sm">{index + 1}</span>
              ...
              {tab === 'controls' && (
                <div className="grid gap-4 p-4 md:grid-cols-2 xl:grid-cols-3">
                  {[
                    ...
                    <article key={title} className="rounded-xl border border-cyan-100 bg-[linear-gradient(180deg,#ffffff_0%,#f0fdff_100%)] p-5 shadow-sm shadow-cyan-900/5">
              ...
              {tab === 'financials' && (
                <div className="grid gap-4 p-4 lg:grid-cols-[0.85fr_1.15fr]">
                  ...
                  <div className="rounded-xl border border-cyan-100 bg-cyan-50/45 p-5">
                    <p className="text-[10px] font-black uppercase tracking-[0.16em] text-cyan-700">Routing mix</p>
